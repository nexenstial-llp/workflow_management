...
const Sidebar = (props) => {
    ...
    const items = [
        ...
        {
            label: <p className='text-[var(--secondary)] font-semibold'>Add New Business</p>,
            key: '3',
            icon: <PlusOutlined />,
            // danger: true,
        }
    ...
    return (
        <div className="p-[20px] h-[100%] border-r-[1px] flex flex-col max-h-[100%]">
            <div className=' text-3xl font-bold text-nex'>
                    Nexenstial
                </div>
            ...
            <ul className="mt-[30px] pt-[30px] border-t-[1px] ">
                {
                    SidebarOptions.map((option, index) => {
                        return (
                            ...
                            <li className={"p-[10px] rounded-[4px] flex gap-[10px] text-center flex items-center text-[18px] cursor-pointer my-[10px] " + (selected == option?.name ? " bg-[#000] text-white" : " text-[#00000080] font-[500]")} onClick={(e) => {
                ...
                <button className='w-[100%] flex gap-[20px] items-center bg-[#000]/[0.1] rounded-[4px] p-[15px] items-center text-[18px] font-bold mt-auto'
                onClick={(e) => {
